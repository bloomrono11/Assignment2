 ...
 * @copyright : None
 */
class InstructionDialogFrag: DialogFragment() {

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, bundle: Bundle?): View {

        val rootView: View = inflater.inflate(R.layout.instruction_rating_dialog, container, false)

        val radioGrp: RadioGroup = rootView.findViewById(R.id.instRadioGroup)
        ...
        val submitBtn: Button = rootView.findViewById(R.id.submitBtn)
