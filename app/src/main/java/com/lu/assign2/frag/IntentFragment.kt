...
class IntentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val locationBtn: Button = inflate.findViewById(R.id.locationBtn)
        ...
        locationBtn.setOnClickListener { findMyLocation(inflate.context) }
        return inflate
    }
    ...
    private fun findMyLocation(context: Context) {
        TODO("Not yet implemented")
    }
